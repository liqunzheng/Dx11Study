...
{
	m_strName = L"CFontShader";
	m_strPSName = L"Font.ps";
	m_strVSName = L"Font.vs";
...
bool CFontShader::Initialize(CD3D11Class* p3DRoot)
{
...
bool CFontShader::Render(CD3D11Class* p3DRoot, UINT indexCount)
{
	// 绑定顶点布局.
...
bool CFontShader::SetMatrix(CD3D11Class* p3DRoot, D3DXMATRIX mxWorld, D3DXMATRIX mxView, D3DXMATRIX mxProject)
{
...
bool CFontShader::SetShaderResource(CD3D11Class* p3DRoot, ID3D11ShaderResourceView* pResource)
{
	// 设置ps shader资源.
